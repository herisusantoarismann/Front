...
class TodaySeminar extends Component {
  constructor() {
    super();
    this.state = {
      data: [],
  ...
  fetchData = (page) => {
    ...
    fetch(process.env.REACT_APP_SERVER + "seminars/today/" + page, {
      method: "GET",
      headers: {
        ...
        <div className="wrapper">
          ...
          <div className="content-seminar">
            <div className="content-title">
              <h2>
                <a href="/app/dashboard">Seminar</a> / Today
              </h2>
              <Button
                primary
